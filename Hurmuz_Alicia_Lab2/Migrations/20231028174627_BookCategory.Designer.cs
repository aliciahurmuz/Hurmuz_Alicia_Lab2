...
namespace Hurmuz_Alicia_Lab2.Migrations
{
    ...
    [Migration("20231028174627_BookCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hurmuz_Alicia_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hurmuz_Alicia_Lab2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hurmuz_Alicia_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Hurmuz_Alicia_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hurmuz_Alicia_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
